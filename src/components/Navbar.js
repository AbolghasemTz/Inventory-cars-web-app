      ...
      <div className="text-white">
        <div className="flex items-center justify-between">
          <select
            ...
            onChange={onSort}
            value={sort}
            className="bg-transparent text-slate-800 rounded-xl "
          >
            <option className="bg-slate-500 text-slate-200 " value="">
              انتخاب کنید
            </option>
            <option className="bg-slate-500 text-slate-200 " value="latest">
              جدیدترین
            </option>
            <option className="bg-slate-500 text-slate-200 " value="earliest">
              قدیمی ترین
            </option>
          </select>
        </div>
